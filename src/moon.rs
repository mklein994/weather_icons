...
mod tests {
    ...
    const TEST_MOON_PHASES: [(f64, i32, WeatherIcon, WeatherIcon); 101] = [
        ...
        (0.24, 7, WeatherIcon::MoonFirstQuarter, WeatherIcon::MoonAltFirstQuarter),
        (0.25, 7, WeatherIcon::MoonFirstQuarter, WeatherIcon::MoonAltFirstQuarter),
        (0.26, 7, WeatherIcon::MoonFirstQuarter, WeatherIcon::MoonAltFirstQuarter),
        (
            0.27,
            8,
        ...
        (0.74, 21, WeatherIcon::MoonThirdQuarter, WeatherIcon::MoonAltThirdQuarter),
        (0.75, 21, WeatherIcon::MoonThirdQuarter, WeatherIcon::MoonAltThirdQuarter),
        (0.76, 21, WeatherIcon::MoonThirdQuarter, WeatherIcon::MoonAltThirdQuarter),
        (
            0.77,
            22,
